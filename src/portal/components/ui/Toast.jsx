...
export const Toast = ({ toast }) => {
  ...
  return (
    <div style={{ position: "fixed", bottom: 24, left: "50%", transform: "translateX(-50%)", zIndex: 300, display: "flex", alignItems: "center", gap: 11, padding: "12px 17px", borderRadius: 12, background: "var(--surface)", border: "1px solid var(--border)", boxShadow: "var(--shadow-pop)", animation: "popIn 0.2s ease both", maxWidth: "calc(100vw - 40px)" }}>
